const data = [
   ...
   },
   {
      ...
      translations: {
         ...
         zho: {
            official: '圣多美和普林西æ°ä¸»å±åå½',
            common: 'å£å¤ç¾åæ®æè¥¿æ¯',
         },
      },
      latlng: [
         1,
   ...
   },
   {
      name: {
         ...
         nativeName: {
            ara: {
               official: 'Ø¬ÙÙÙØ±ÙØ© ØªØ´Ø§Ø¯',
               common: 'ØªØ´Ø§Ø¯â',
            },
            fra: {
      ...
      translations: {
         ...
         rus: {
            official: 'Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð§Ð°Ð´',
            common: 'Ð§Ð°Ð´',
         },
         slk: {
            official: 'ÄadskÃ¡ republika',
   ...
   },
   {
      ...
      translations: {
         ara: {
            official: 'Ø¬ÙÙÙØ±ÙØ© ÙÙØ±ÙØ´ÙÙØ³',
            common: 'ÙÙØ±ÙØ´ÙÙØ³',
         },
         ces: {
            official: 'MauricijskÃ¡ republika',
            common: 'Mauricius',
         },
         cym: {
            official: 'Republic of Mauritius',
         ...
         hun: {
            official: 'Mauritiusi KÃ¶ztÃ¡rsasÃ¡g',
            common: 'Mauritius',
         },
         ita: {
         ...
         jpn: {
            official: 'ã¢ã¼ãªã·ã£ã¹å±åå½',
            common: 'ã¢ã¼ãªã·ã£ã¹',
         },
         kor: {
            official: 'ëª¨ë¦¬ìì¤ ê³µíêµ­',
            common: 'ëª¨ë¦¬ìì¤',
         },
         nld: {
         ...
         per: {
            official: 'Ø¬ÙÙÙØ±Û ÙÙØ±ÛØ³',
            common: 'ÙÙØ±ÛØ³',
         },
         pol: {
         ...
         por: {
            official: 'RepÃºblica das MaurÃ­cias',
            common: 'MaurÃ­cio',
         },
         rus: {
            official: 'Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ°Ð²ÑÐ¸ÐºÐ¸Ð¹',
            common: 'ÐÐ°Ð²ÑÐ¸ÐºÐ¸Ð¹',
         },
         slk: {
            official: 'MaurÃ­cijskÃ¡ republika',
            common: 'MaurÃ­cius',
         },
         spa: {
            official: 'RepÃºblica de Mauricio',
            common: 'Mauricio',
         },
         swe: {
         ...
         urd: {
            official: 'Ø¬ÙÛÙØ±ÛÛ ÙÙØ±ÛØ´Ø³',
            common: 'ÙÙØ±ÛØ´Ø³',
         },
         zho: {
            official: 'æ¯éæ±æ¯å±åå½',
            common: 'æ¯éæ±æ¯',
         },
      },
      latlng: [
   ...
   },
   {
      ...
      translations: {
         ara: {
            official: 'Ø¬ÙÙÙØ±ÙØ© Ø£ÙØºÙØ¯Ø§',
            common: 'Ø£ÙØºÙØ¯Ø§',
         },
         ces: {
         ...
         jpn: {
            official: 'ã¦ã¬ã³ãå±åå½',
            common: 'ã¦ã¬ã³ã',
         },
         kor: {
            official: 'ì°ê°ë¤ ê³µíêµ­',
            common: 'ì°ê°ë¤',
         },
         nld: {
         ...
         per: {
            official: 'Ø¬ÙÙÙØ±Û Ø§ÙÚ¯Ø§ÙØ¯Ø§',
            common: 'Ø§ÙÚ¯Ø§ÙØ¯Ø§',
         },
         pol: {
         ...
         rus: {
            official: 'Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð£Ð³Ð°Ð½Ð´Ð°',
            common: 'Ð£Ð³Ð°Ð½Ð´Ð°',
         },
         slk: {
            official: 'UgandskÃ¡ republika',
         ...
         urd: {
            official: 'Ø¬ÙÛÙØ±ÛÛ ÛÙÚ¯ÙÚØ§',
            common: 'ÛÙÚ¯ÙÚØ§',
         },
         zho: {
            official: 'ä¹å¹²è¾¾å±åå½',
            common: 'ä¹å¹²è¾¾',
         },
      },
      latlng: [
   ...
   },
   {
      ...
      translations: {
         ara: {
            official: 'Ø¬ÙÙÙØ±ÙØ© ÙØ§Ø¨Ù ÙÙØ±Ø¯Ù',
            common: 'ÙØ§Ø¨Ù ÙÙØ±Ø¯Ù',
         },
         ces: {
         ...
         per: {
            official: 'Ø¬ÙÙÙØ±Û Ú©Ø¨Ù ÙØ±Ø¯',
         ...
         rus: {
            official: 'Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ°Ð±Ð¾ -ÐÐµÑÐ´Ðµ',
            common: 'ÐÐ°Ð±Ð¾-ÐÐµÑÐ´Ðµ',
         },
         slk: {
            official: 'KapverdskÃ¡ republika',
            common: 'Kapverdy',
         ...
         urd: {
            official: 'Ø¬ÙÛÙØ±ÛÛ Ú©ÛÙ¾ ÙØ±ÚÛ',
            common: 'Ú©ÛÙ¾ ÙØ±ÚÛ',
         },
         zho: {
            official: 'ä½å¾è§å±åå½',
            common: 'ä½å¾è§',
   ...
   },
   {
      ...
      translations: {
         ara: {
            official: 'Ø¬ÙÙÙØ±ÙØ© Ø¨ÙØ±ÙÙØ¯Ù',
            common: 'Ø¨ÙØ±ÙÙØ¯Ù',
         },
         ces: {
         ...
         per: {
            official: 'Ø¬ÙÙÙØ±Û Ø¨ÙØ±ÙÙØ¯Û',
            common: 'Ø¨ÙØ±ÙÙØ¯Û',
         },
         pol: {
         ...
         rus: {
            official: 'Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÑÑÑÐ½Ð´Ð¸',
            common: 'ÐÑÑÑÐ½Ð´Ð¸',
         },
         slk: {
            official: 'BurundskÃ¡ republika',
            common: 'Burundi',
         ...
         urd: {
            official: 'Ø¬ÙÛÙØ±ÛÛ Ø¨Ø±ÙÙÚÛ',
            common: 'Ø¨Ø±ÙÙÚÛ',
         },
         zho: {
            official: 'å¸éè¿ªå±åå½',
            common: 'å¸éè¿ª',
         },
      },
      latlng: [
   ...
   },
   {
      name: {
         ...
         nativeName: {
            ara: {
               official: 'Ø§ÙØ§ØªØ­Ø§Ø¯ Ø§ÙÙÙØ±Ù',
               common: 'Ø§ÙÙÙØ±â',
            },
            fra: {
      ...
      translations: {
         ara: {
            official: 'Ø§ÙØ¥ØªØ­Ø§Ø¯ Ø§ÙÙÙØ±Ù',
            common: 'Ø¬Ø²Ø± Ø§ÙÙÙØ±',
         },
         ces: {
            official: 'KomorskÃ½ svaz',
            common: 'Komory',
         },
         cym: {
         ...
         hun: {
            official: 'Comore-szigeteki UniÃ³',
         ...
         per: {
            official: 'ÙØ¬ÙØ¹âØ§ÙØ¬Ø²Ø§ÛØ± ÙÙØ±',
            common: 'Ø§ØªØ­Ø§Ø¯ ÙÙÙÙØ±',
         },
         pol: {
            official: 'ZwiÄzek KomorÃ³w',
            common: 'Komory',
         },
         por: {
            official: 'UniÃ£o das Comores',
            common: 'Comores',
         },
         rus: {
            official: 'Ð¡Ð¾ÑÐ· ÐÐ¾Ð¼Ð¾ÑÑÐºÐ¸Ñ ÐÑÑÑÐ¾Ð²Ð¾Ð²',
            common: 'ÐÐ¾Ð¼Ð¾ÑÑ',
         },
         slk: {
            official: 'KomorskÃ¡ Ãºnia',
            common: 'Komory',
         },
         spa: {
            official: 'UniÃ³n de las Comoras',
            common: 'Comoras',
         },
         swe: {
         ...
         urd: {
            official: 'Ø§ØªØ­Ø§Ø¯ Ø§ÙÙÙØ±Û',
            common: 'Ø§ÙÙÙØ±Û',
         },
         zho: {
            official: 'ç§æ©ç½èç',
